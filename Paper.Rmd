...
qplot(x=factor(dat$social_status), y = datRaw$prominence, data = dat, geom = c("boxplot"), xlab = "Social status", ylab = "Prominence")
...
ROC <- list(Manual = ROC_Manual, Elastic_min = ROC_Elastic_min)
map_dbl(ROC, "AUC")
